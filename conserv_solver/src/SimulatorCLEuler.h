...
#ifndef GLAppNative_SimulatorCLEuler_h
#define GLAppNative_SimulatorCLEuler_h
...
class SimulatorCLEuler : public SimulatorBase{
public:
    /**
	 * Constructor
	 */
	SimulatorCLEuler(cl_device_type device);
    
	/**
	 * Destructor
	 */
	virtual ~SimulatorCLEuler();
